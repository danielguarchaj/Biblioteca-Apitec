var Paises = [];//arreglo que contendra los objetos paises
//arreglo con el nombre de cada pais que se usara para crear el arreglo de objetos con su nombre y id respectivo
...
//ciclo que recorre cada elemento del arreglo mundo e inserta un nuevo objeto al arreglo Paises
$.each(mundo, function(index, valor) {
    var pais = {
        id: index + 1,
        nombre: valor
    }
...
//Funcion que no recibe parametros y guarda el arreglo Paises en localStorage
function GuardarPaises() {
    localStorage.setItem('paises', JSON.stringify(Paises));
}

//se llama a la fucnion GuardarPaises
GuardarPaises();
